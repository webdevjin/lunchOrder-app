...
student_1 = Student.create(name:'Sally', grade:'1T', user_id:'')
student_2 = Student.create(name:'Tom', grade:'4A', user_id:'')
student_3 = Student.create(name:'Greg', grade:'3S', user_id:'')
student_4 = Student.create(name:'John', grade:'2E', user_id:'')
student_5 = Student.create(name:'Rose', grade:'6R', user_id:'')
student_6 = Student.create(name:'Lara', grade:'4C', user_id:'')
student_7 = Student.create(name:'Helen', grade:'5F', user_id:'')
