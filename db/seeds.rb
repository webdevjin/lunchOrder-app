...
student_1 = Student.create(name:'Sally', grade:'1T', user_id:user_1.id)
student_2 = Student.create(name:'Tom', grade:'4A', user_id:user_2.id)
student_3 = Student.create(name:'Greg', grade:'3S', user_id:user_3.id)
student_4 = Student.create(name:'John', grade:'2E', user_id:user_4.id)
student_5 = Student.create(name:'Rose', grade:'6R', user_id:user_5.id)
student_6 = Student.create(name:'Lara', grade:'4C', user_id:user_6.id)
...
lineItem_2 = LineItem.create(user_id: user_2.id, student_id: student_3.id, order_id: order_2.id, lunch_id: lunch_2.id, qty:2)
lineItem_3 = LineItem.create(user_id: user_3.id, student_id: student_2.id, order_id: order_3.id, lunch_id: lunch_3.id, qty:1)
